...
exports.FindTransactionNftDto = void 0;
const swagger_1 = require("@nestjs/swagger");
const class_validator_1 = require("class-validator");
const cursor_filter_dto_1 = require("../../common/pagination/cursor-filter.dto");
const class_transformer_1 = require("class-transformer");
class FindTransactionNftDto extends cursor_filter_dto_1.CursorFilterDto {
    constructor() {
        super(...arguments);
...
], FindTransactionNftDto.prototype, "walletAddress", void 0);
__decorate([
...
], FindTransactionNftDto.prototype, "orderParam", void 0);
__decorate([
    ...
    (0, class_validator_1.IsOptional)(),
    __metadata("design:type", Object)
], FindTransactionNftDto.prototype, "limit", void 0);
exports.FindTransactionNftDto = FindTransactionNftDto;
//# sourceMappingURL=find-transaction-nft.dto.js.map