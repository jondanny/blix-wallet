export declare const WEB3_PROVIDER_TOKEN = "Web3ProviderToken";
export declare const BICONOMY_PROVIDER_TOKEN = "BiconomyProviderToken";
export declare enum Web3EventPattern {
